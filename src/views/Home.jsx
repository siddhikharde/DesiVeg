...
function Home() {
  return (
    ...
    <div className='p-4'>
        <h2 className='text-center text-[40px]! font-bold text-[#1B5E20]'>Why Choose Us ?</h2>
        <div className='w-full flex md:flex-row flex-col p-4 justify-around items-center gap-5'>
